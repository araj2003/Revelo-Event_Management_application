    ...
    <div className="header ">
      ...
      <div className="">
        ...
        <div
          ...
          className={`z-20 ${showNotification ? "absolute" : "hidden"} w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700`}
